  ...
  return (
    <main className="container mx-auto p-2 grid grid-cols-1 gap-y-10">
      <section className="container mx-auto grid md:grid-cols-2 gap-5 mt-10">
        <article className="border bg-gray-950 rounded-lg p-3 relative z-0">
          <iframe
          ...
          <div className=" w-fit p-5 text-gray-400 rounded-lg absolute bottom-3 left-3">
            <div className="bg-gray-950 opacity-90 p-3 rounded-lg mb-2">
              <div className="flex gap-2 items-center mb-2">
                ...
                <h1 className="text-2xl text-orange-500">Our Location</h1>
              </div>
        ...
        <article className="bg-gray-950 p-5 rounded-lg text-gray-400">
          <Form {...form}>
            <form
              onSubmit={form.handleSubmit(submimssion)}
              className="space-y-6"
            >
              {/* Name */}
              <FormField
