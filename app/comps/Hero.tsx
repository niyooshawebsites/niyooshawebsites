  ...
  return (
    <section className=" rounded-3xl p-10 bg-gray-950 ">
      ...
      <article className="flex flex-col justify-center items-center -mt-32">
        <h1 className="text-7xl text-gray-400 font-bold tracking-tight text-center">
          Niyoosha <span className=" text-orange-500">Websites</span>
        </h1>
        <p className="mt-6 text-center text-muted-foreground mx-auto max-w-xl text-gray-400">
        ...
        <div className="mt-8 flex justify-center gap-4 text-gray-400">
          <Button
            size="lg"
            variant="secondary"
            className="bg-orange-500 text-gray-100 shadow-lg shadow-orange-500/50 cursor-pointer hover:translate-y-0.5 hover:bg-orange-600 hover:text-gray-950"
          >
            Contact us
          </Button>
          <Button
