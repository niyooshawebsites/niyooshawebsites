  ...
  return (
    <section className="container mx-auto my-10">
      ...
      <p className="mt-5 text-gray-400">
        ...
        the ever-evolving landscape of the online world, we understand the
        critical importance of a strong, user-friendly website coupled with a
      ...
      <p className="mt-5 text-gray-400">
        ...
        also convert visitors into loyal customers. Our team of skilled
        developers, designers, and SEO experts collaborate seamlessly to deliver
